    ...
    return (
        <div className='container-contacto'>
            ...
            <div className='container-redes'>
                ...
                <a href="https://www.instagram.com/scalcini.constructora?igsh=MnU0a285c3RqanZ1&utm_source=qr" target='_blank'><img src={instagramcontacto} alt="" /></a>
                <a href="https://www.facebook.com/profile.php?id=61571912578351&locale=es_LA" target='_blank'><img src={facebookcontacto} alt="" /></a>
                <a href="https://www.linkedin.com/in/luciano-scalcini-b73a7ab0/?originalSubdomain=ar" target='_blank'><img src={linkedincontacto} alt="" /></a>
