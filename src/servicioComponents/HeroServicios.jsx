export const HeroServicios = () => {
  return (
    <div className="container-hero-servicios">
      <div
        className="container-info-hero-servicios container-izquierda"
        id="container-servicios-1"
      >
        <h3>Construcción</h3>
      ...
      <div
        className="container-info-hero-servicios container-derecha"
        id="container-servicios-2"
      >
        <h3>Topografía</h3>
        <div className="container-p-servicios">
          <p style={{ marginTop: "5px" }}>
            Replanteos, verticalizacion de edificios, asistencia de movimiento
