...
export const Formulario = () => {
  ...
  const sendEmail = () => {
    emailjs.sendForm('API_KEY1', 'API_KEY2', form.current, {
      publicKey: 'API_KEY3',
    })
      .then(
        (result) => {
  ...
  function validarFormulario() {
    ...
    if (formData.user_telefono.length < 8) {
      errors.user_telefono = '¡El número de teléfono debe tener al menos 8 dígitos, incluyendo el código de área!';
      validacionCorrecta = false;
    ...
    <div id='containerForm'>
      <form ref={form} id='Form' onSubmit={submitFunction}>
        ...
        <input
          ...
          autoComplete='on'
        />
        {formErrors.user_name && <div className="error" style={{ marginBottom: '5px' }}>{formErrors.user_name}</div>}
        ...
        <input
          ...
          autoComplete='on'
        />
        {formErrors.user_email && <div className="error" style={{ marginBottom: '5px' }}>{formErrors.user_email}</div>}
        ...
        <input
          ...
          autoComplete='on'
        />
        {formErrors.user_telefono && <div className="error" style={{ marginBottom: '5px' }}>{formErrors.user_telefono}</div>}
        ...
        <input
          ...
          autoComplete='off'
        />
        {formErrors.user_subject && <div className="error" style={{ marginBottom: '5px' }}>{formErrors.user_subject}</div>}
        ...
        <textarea
          ...
          autoComplete='off'
        ></textarea>
        {formErrors.user_message && <div className="error" style={{ marginBottom: '5px', fontWeight: '650' }}>{formErrors.user_message}</div>}
