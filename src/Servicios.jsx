...
export const Servicios = () => {
  ...
  const punto1 =
    "• Control de suelos y supervisión de obras de hormigón (>1000 m³).";
  const punto2 =
    "• Supervisión de terraplenes (4 km) y pavimentos rígidos (1 km).";
  ...
  const punto33 =
    "• Mecánica industrial: Montajes y reparaciones de maquinaria.";
  ...
  const punto43 =
    "• Dirección de obra y logística en construcciones edilicias.";

  return (
    <div className="container-servicio">
      <h1 className="title-servicio" id="titulo-servicios">
        Servicios
      </h1>

      <HeroServicios />

      <h1 className="title-servicio">
        Luciano <span className="spanBold">Scalcini</span>
      </h1>

      <h2 className="subtitle-servicio">
        Topógrafo, Ingeniero <br /> Analista de Datos y Proyector
      </h2>
