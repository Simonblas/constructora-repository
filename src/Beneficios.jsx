  ...
  return (
    <div className="container-beneficios">
      <h1 className="titulo-beneficios">
        Beneficios <span className="spanBold">clave</span>
      </h1>
      ...
      <div className="extra-beneficios">
        <div className="extra-item">
          ...
          <p>
            Galpones y tinglados llave en mano, diseñados sin limitaciones de
            tamaño.
          </p>
        </div>
        <div className="extra-item" id="borde-vertical-medio">
          ...
          <p>
            Nos adaptamos a las necesidades de cada cliente, ofreciendo
        ...
        <div className="extra-item">
          ...
          <p>
            Nos encargamos de todo, desde la fabricación hasta el montaje, con
